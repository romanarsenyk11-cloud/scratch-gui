...
const randomMessages = [
    "MistBolt's anniversary is less than a year away! - Nameless",
    'ur gay - Flufi',
    ...
    'we have more themes than NitroBolt, which makes MistBolt better - Mistium',
    'Femboys can be not gray - JustNoone',
    'Nitrobolt cringe fr fr ong no cap (real) (not gone wrong) (mistbolt better real) - Flufi',
    ...
    'Programer socks are part of the official MistBolt uniform - Nameless',
    'Wear thigh highs or die :3 - Flufi',
    'This mod has no swears, pg family friendly - Mistium',
    'Grah - Flufi',
    'I am a professional MistBolt user - Nameless',
    'Next person to be confused by this quote is gay - Flufi',
    'Look under there',
    'do not the mistbolt - Flufi',
    'how sign in to mistbolt - Andrew',
    'if only mistbolt was less mist and more bolt - Mistium',
    'i just laughed so hard i died - Flufi',
    'I just laughed so hard that I just laughed so hard - ViMi',
    'i own nitrobolt and penguinmod - Andrew',
